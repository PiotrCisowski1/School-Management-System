...
import com.cisowski.schoolmanagement.common.security.authorization.policy.ParentAccessPolicy;
...
class ParentAccessPolicyTest {
    ...
    @Test
    void getResourceType_ShouldReturnParent() {
        ParentAccessPolicy policy = new ParentAccessPolicy(handlers);
    ...
    void canAccess_WhenUserIsNotAdministratorAndHandlerDoesNotExist_ShouldThrowException() {
        ...
        PermissionHandlerKey key = new PermissionHandlerKey(userType, ResourceType.PARENT);
        ...
        assertTrue(thrown.getMessage().contains(ResourceType.PARENT.name()));
