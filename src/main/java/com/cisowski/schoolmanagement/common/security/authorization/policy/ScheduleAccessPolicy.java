...
@Component("SCHEDULE")
public class ScheduleAccessPolicy extends BaseResourceAccessPolicy<ScheduleEntity> {

    public ScheduleAccessPolicy(Map<PermissionHandlerKey, ResourcePermissionHandler<?>> handlers) {
        super(handlers);
    }
