...
import com.cisowski.schoolmanagement.common.security.authorization.handler.impl.student.StudentStudentPermissionHandler;
...
class StudentStudentPermissionHandlerTest {
    ...
    @InjectMocks
    private StudentStudentPermissionHandler handler;
    ...
    @Test
    void canAccess_WhenActionIsReadAndStudentIdMatches_ShouldReturnTrue() {
    ...
    @Test
    void canAccess_WhenActionIsReadAndStudentIdDoesNotMatch_ShouldReturnFalse() {
        StudentEntity student = Instancio.create(StudentEntity.class);
        Integer differentStudentId = student.getId() + 1;
