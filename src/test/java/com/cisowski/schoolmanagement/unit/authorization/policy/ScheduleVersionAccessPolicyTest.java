...
import com.cisowski.schoolmanagement.common.security.authorization.policy.ScheduleVersionAccessPolicy;
...
class ScheduleVersionAccessPolicyTest {
    ...
    @Test
    void getResourceType_ShouldReturnScheduleVersion() {
        ScheduleVersionAccessPolicy policy = new ScheduleVersionAccessPolicy(handlers);
    ...
    void canAccess_WhenUserIsNotAdministratorAndHandlerDoesNotExist_ShouldThrowException() {
        ...
        PermissionHandlerKey key = new PermissionHandlerKey(userType, ResourceType.SCHEDULE_VERSION);
        ...
        assertTrue(thrown.getMessage().contains(ResourceType.SCHEDULE_VERSION.name()));
