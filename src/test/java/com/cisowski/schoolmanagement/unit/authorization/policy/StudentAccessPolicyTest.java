...
import com.cisowski.schoolmanagement.common.security.authorization.policy.StudentAccessPolicy;
...
class StudentAccessPolicyTest {
    ...
    @Test
    void getResourceType_ShouldReturnStudent() {
        StudentAccessPolicy policy = new StudentAccessPolicy(handlers);
    ...
    void canAccess_WhenUserIsNotAdministratorAndHandlerDoesNotExist_ShouldThrowException() {
        ...
        PermissionHandlerKey key = new PermissionHandlerKey(userType, ResourceType.STUDENT);
        ...
        assertTrue(thrown.getMessage().contains(ResourceType.STUDENT.name()));
