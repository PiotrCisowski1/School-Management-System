...
@Component("CLASSROOM")
public class ClassroomAccessPolicy extends BaseResourceAccessPolicy<GradeEntity> {

    public ClassroomAccessPolicy(Map<PermissionHandlerKey, ResourcePermissionHandler<?>> handlers) {
        super(handlers);
    }
