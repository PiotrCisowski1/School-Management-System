...
@Component("SUBJECT")
public class SubjectAccessPolicy extends BaseResourceAccessPolicy<SubjectEntity> {

    public SubjectAccessPolicy(Map<PermissionHandlerKey, ResourcePermissionHandler<?>> handlers) {
        super(handlers);
    }
